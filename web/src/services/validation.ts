...
const SYSTEM_PROMPT = `소설의 **심각한 설정 오류**만 찾으세요. 애매하면 보고하지 마세요.

## 보고할 오류 (2가지만)

1. **사망 오류**: 살아있던 캐릭터가 사망 장면 없이 갑자기 죽어있음
2. **설정 모순**: 동일 캐릭터의 종족/출신지가 **직접적으로 모순**됨
   - 예: "나는 고양이다" → "나는 개다" (같은 화자)
...
## JSON 응답
{"summary": "요약", "issues": [{"type": "유형", "description": "설명"}]}

issues가 없으면 빈 배열: {"summary": "이상 없음", "issues": []}`;
