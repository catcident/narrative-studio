...
## 중요: 원본 텍스트 기준으로 판단
- **원본 텍스트**만이 진실입니다
- "등장인물/엔티티", "관계" 섹션은 AI가 분석한 결과로, **틀릴 수 있습니다**
- 분석 결과와 원본이 다르면 → **분석 오류**이지 소설 오류가 아닙니다
- 반드시 원본 텍스트에서 직접 확인한 내용만 보고하세요

## 찾아야 할 오류 (원본 텍스트에서 확인된 것만)
