...
const SYSTEM_PROMPT = `소설 설정 검증. 아래 2가지만 오류로 보고:

1. **사망 오류**: 사망 장면 없이 갑자기 죽어있음
2. **종족/출신 변경**: 동일 화자가 이전 발언과 직접 모순

다음은 오류 아님:
- 별칭/이름 부여
- 새 캐릭터/정보

JSON 형식 (description 필수):
{"summary": "요약", "issues": [{"type": "오류유형", "description": "구체적 설명 (어떤 캐릭터가 어떻게 모순되는지)"}]}
