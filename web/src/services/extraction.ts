...
- 인물: 대화/행동/언급되는 모든 캐릭터 (동물 포함, 이름 없으면 "검은 고양이" 등 특징으로)
- 장소: 언급되는 모든 장소 (배경, 이동 목적지, 회상 속 장소 등)
- 물건: 등장하는 모든 물건 (소품, 아이템, 소지품 등)
- 개념: 세계관 설정, 규칙, 추상적 요소
...
### 5. 엔티티 구분 vs 통일
- **물리적으로 다른 객체 = 별개**: "골목 끝 박스" vs "잠자는 박스" → 둘 다 추출
- **같은 개념 = 통일**: 이전에 "시간의 역전"이 있으면 "역전된 인과관계"도 같은 이름 사용
