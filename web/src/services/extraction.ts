...
### 7. ⚠️ 비슷한 이름의 엔티티 구분 필수!
- **역할, 위치, 특성이 다르면 별개 엔티티로 추출하세요**
- 이름이 비슷해도 용도가 다르면 다른 엔티티임
- 예: "주인공이 자는 골판지 상자"와 "차원이동하는 큰 박스"는 별개
- 예: "골목의 쓰레기통"과 "학교 앞 쓰레기통"은 별개
- description에 각 엔티티의 고유한 특성/역할을 명확히 기록하세요`;
